...
class CSPMiddleware(MiddlewareMixin):
    """The rec's JavaScript should be compatible with CSP."""
    def process_response(self, request, response):
        response['Content-Security-Policy'] = "default-src 'self'"
        return response


@modify_settings(MIDDLEWARE={'append': 'django.contrib.rec.tests.CSPMiddleware'})
class RecSeleniumTestCase(SeleniumTestCase, StaticLiveServerTestCase):
    ...
    def rec_login(self, username, password, login_url='/rec/'):
        """
        Log in to the rec.
        """
